...
namespace MonstersDomain
{
    public class ItemManager : InventorySystem
    {
        ...
        //[SerializeField, Tooltip("インベントリ容量")] int _inventorySize = 5;
        ...
        void Start()
        {
            InputProvider.Instance.SelectHotbarAxis
                .Subscribe(axis => _hotbar.Scroll(axis, ItemContainer, EquipmentItem)).AddTo(this);
        ...
        void UseItem(Unit _)
        {
            ...
            if (EquippedItem.TryGetComponent(out IUsable usable)) usable.Use();
